...
for rho in Rho:
    ...
    tau = np.sqrt(2.5);
    b = 0.;
    N=2; ndraws = 2500; alpha = 0.05;   ##ndraws = 2500 for K=700,pi=0.3, ndraws = 2500 for K=1400,pi=0.1
    scov = lil_matrix((K, K))
    ...
    import concurrent.futures
    from functools import partial
    rep = 3500;     ##### Number of replicates for determining estimates(3500 for K=700,pi=0.3,3500 for K=1400, pi=0.1)
...
print(RC)
np.save('RC_compare_lcfdrNvslcfdr_pi_01.npy',np.array(RC));
